...
(function (b) {
  ...
  b.extend(!0, g.defaults, {
    dom: "<'row uk-grid '<'uk-width-1-2@l uk-margin-small'l><'uk-width-1-2@l uk-margin-small'f>><'row uk-grid dt-merge-grid'<'uk-width-1-1'tr>><'row uk-grid dt-merge-grid'<'uk-width-2-5'i><'uk-width-3-5'p>>",
    renderer: "uikit"
  });
  ...
  g.ext.renderer.pageButton.uikit = function (a, h, r, m, j, n) {
    ...
    q(b(h).empty().html('<ul class="uk-pagination uk-pagination-right uk-flex-right"/>').children("ul"),
      m);
