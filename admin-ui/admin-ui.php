...
function fau_login_theme_style() {
  ...
  if(get_option( 'fau_secondary_color') != ""):
    ...
    $fau_secondary    = "#18ae81 !important";
  endif;

  wp_enqueue_style(
    'fau-login-style',
	  get_template_directory_uri() . '/admin-ui/css/fau_styles_login.css'
	);
...
function fau_admin_bar_theme_style() {
  ...
  if(get_option( 'fau_secondary_color') != ""):
    ...
    $fau_secondary    = "#a71a16 !important";
  endif;

  wp_enqueue_style(
		'fau-admin-bar-style',
	  get_template_directory_uri() . '/admin-ui/css/fau_styles_adminbar.css'
	);
...
function fau_admin_theme_style() {
  ...
  if(get_option( 'fau_secondary_color') != ""):
    ...
    $fau_secondary    = "#333 !important";
  endif;

  wp_enqueue_style(
		'fau-admin-style',
	  get_template_directory_uri() . '/admin-ui/css/fau_styles_admin.css'
	);
...
function fau_swap_footer_admin() {
  echo 'Custom Admin UI by <a href="http://www.aligodu.cm" target="_blank">Aligodu</a>';
}
